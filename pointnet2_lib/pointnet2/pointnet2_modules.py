...
class PointnetFPModule(nn.Module):
    ...
    def forward(
        ...
        print("interpolated_feats:{}".format(interpolated_feats.shape))
        print("unknow_feats:{}".format(unknow_feats.shape))
        print("before mlp new_feature:{}".format(new_features.shape))
        new_features = new_features.unsqueeze(-1)
        new_features = self.mlp(new_features)
        print("after mlp new_feature:{}".format(new_features.shape))
